...
public class ReportMetricsSplitFinishedStatusEvent implements SourceEvent {
    ...
    private final Long finishedSplitSize;

    private final Long totalSplitSize;


    public ReportMetricsSplitFinishedStatusEvent(Long finishedSplitSize, Long totalSplitSize) {
        this.finishedSplitSize = finishedSplitSize;
        this.totalSplitSize = totalSplitSize;
    }

    public Long getFinishedSplitSize() {
        return finishedSplitSize;
    }

    public Long getTotalSplitSize() {
        return totalSplitSize;
    }
}
